...
export class ScreeningsService{
    ...
    async seed() {
        const screenings : Screening[] = [
            ...
            new Screening(4,  new Date("2025-05-12T19:00:00Z"), this.computeEndsAt(new Date("2025-05-12T19:00:00Z"), await this.moviesService.getMovie({id: 47})), await this.roomsService.findByName("Tornado")       , await this.moviesService.getMovie({id: 47})),
            ...
            new Screening(22, new Date("2025-05-18T11:00:00Z"), this.computeEndsAt(new Date("2025-05-18T11:00:00Z"),await this.moviesService.getMovie({id: 47})), await this.roomsService.findByName("Évasion")       , await this.moviesService.getMovie({id: 47})),
            ...
            new Screening(32, new Date("2025-05-22T13:00:00Z"), this.computeEndsAt(new Date("2025-05-22T13:00:00Z"),await this.moviesService.getMovie({id: 47})), await this.roomsService.findByName("Évasion")       , await this.moviesService.getMovie({id: 47})),
            ...
            new Screening(44, new Date("2025-05-26T20:00:00Z"), this.computeEndsAt(new Date("2025-05-26T20:00:00Z"),await this.moviesService.getMovie({id: 47})), await this.roomsService.findByName("Évasion")       , await this.moviesService.getMovie({id: 47})),
            ...
            new Screening(58, new Date("2025-05-30T13:00:00Z"), this.computeEndsAt(new Date("2025-05-30T13:00:00Z"),await this.moviesService.getMovie({id: 47})), await this.roomsService.findByName("Studio 1")      , await this.moviesService.getMovie({id: 47})),
